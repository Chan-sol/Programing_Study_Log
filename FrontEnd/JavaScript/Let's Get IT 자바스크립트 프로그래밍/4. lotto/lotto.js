...
const startLotto = () => {
    ...
    function createBall(number, $parent) {
        ...
        switch(parseInt(number/10)){
            case 0: 
                $ball.style.backgroundImage = "url('red.png')";
                $ball.style.color = "white";
                break;
            case 1: $ball.style.backgroundImage = "url('orange.png')"; break;
            case 2: $ball.style.backgroundImage = "url('yellow.png')"; break;
            case 3: 
                $ball.style.backgroundImage = "url('blue.png')";
                $ball.style.color = "white";
                break;
            default: 
                $ball.style.backgroundImage = "url('green.png')";
                $ball.style.color = "white";
                break;
        }
